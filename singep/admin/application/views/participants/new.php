...
<div class="container body">
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <?php echo form_open( 'participants/newParticipant', array( 'id' => 'form-new-participant', 'class' => 'form-horizontal form-label-left') )  ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="100" type="text" name="email" id="email" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="25" type="text" name="documento" id="documento" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input data-inputmask="'mask' : '9{0,1}9{0,1}(99) 9{4,5}-9999'" maxlength="50" type="text" name="telefone" id="telefone" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="200" type="text" name="filiacao" id="filiacao" class="form-control col-md-7 col-xs-12">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $( "#form-new-participant").on( 'submit', function( e ) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo base_url('participants/newParticipant'); ?>',
                    type: "POST",
                    data:  formData,
                    contentType: false,
                    cache: false,
                    ...
                    success: function( data ) {
                        ...
                        if( data[ "clean" ] == false ) {
                            ...
                            $( '#adm_error').html( 'Participante cadastrado com sucesso!' );
