        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Formulário de cadastro <small>preencha todos os campos</small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <?php echo form_open_multipart( 'speakers/newSpeaker', array( 'id' => 'form-new-speaker', 'class' => 'form-horizontal form-label-left') )  ?>
                                ...
                                <div class="form-group" style="margin-top: 5px;">
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        ...
                                        <div id="result-cropp" class="cropper-bg image-preview-container"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="100" type="text" name="nome" id="nome" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="100" type="text" id="cidade" name="cidade" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="100" type="text" id="estado" name="estado" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="100" type="text" id="email" name="email" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input maxlength="200" type="text" id="filiacao" name="filiacao" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea name="curriculo" id="curriculo" class="form-control" rows="3"></textarea>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $button.on('click', function ( e ) {
            ...
            // Show
            $result.html('<img src="' + cropImage + '">');

        });

        // Form new speaker

        $( "#form-new-speaker").on( 'submit', function( e ) {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url('speakers/newSpeaker'); ?>',
                type: "POST",
                data:  formData,
                ...
                success: function( data ) {
                   ...
                   if( data[ "clean" ] == false ) {
                       ...
                       $( '#curriculo_error').html( 'Usuário cadastrado com sucesso!' );
